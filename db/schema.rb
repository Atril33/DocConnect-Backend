...
ActiveRecord::Schema[7.0].define(version: 2023_09_30_203801) do
  ...
  create_table "appointments", force: :cascade do |t|
    ...
    t.index ["doctor_id", "appointment_date", "appointment_time"], name: "unique_appointment_datetime", unique: true
